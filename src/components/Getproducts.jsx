...
const Getproducts = () => {
  ...
  // Initialize hooks to help you manage your state of your application
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden card-hover border border-gray-100">
                ...
                <div className='p-3 sm:p-4 relative'>
                  ...
                  <div className="flex gap-2">
                    <button
                      className="flex-1 bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold py-2 px-3 rounded-lg flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-all duration-300 text-xs sm:text-sm"
