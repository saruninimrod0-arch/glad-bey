...
const ProductCartButton = ({ product }) => {
  ...
  const addToCart = (productToAdd) => {
    const productId = productToAdd.product_id || productToAdd.id || productToAdd.product_name;
  ...
  return (
    <>
      {/* Cart Button on Product Card - Simplified to reduce flickering */}
      <button
        onClick={handleCartClick}
        className="bg-gradient-to-r from-purple-600 to-pink-600 text-white p-2 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-200 relative"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[80vh] flex flex-col overflow-hidden">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-purple-600 to-pink-600">
              <h3 className="text-white font-semibold text-lg">Product Cart ({cartTotals.totalItems} items)</h3>
              <button
            ...
            <div className="flex-1 overflow-y-auto px-6 py-4">
              {cartItems.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-12 text-gray-400">
                  ...
                  <p className="text-lg font-medium">Product cart is empty</p>
                  <p className="text-sm">Click the cart button to add this product!</p>
                </div>
              ) : (
            ...
            <div className="border-t border-gray-200 px-6 py-4 bg-gray-50">
              ...
              <button className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold py-3 rounded-lg hover:shadow-lg transition-shadow duration-200">
                Proceed to Checkout
              </button>
            </div>
          </div>
